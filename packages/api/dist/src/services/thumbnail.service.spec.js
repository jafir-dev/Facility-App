...
describe('ThumbnailService', () => {
    ...
    beforeEach(async () => {
        ...
        service = module.get(thumbnail_service_1.ThumbnailService);
    ...
    describe('generateMultipleThumbnails', () => {
        it('should generate multiple thumbnails', async () => {
            ...
            const result = await service.generateMultipleThumbnails(originalPath, 'test.jpg', 'ticket-123', sizes);
    ...
    describe('deleteThumbnails', () => {
        it('should delete specific thumbnail', async () => {
            ...
            expect(fsMock.pathExists).toHaveBeenCalled();
            expect(fsMock.remove).toHaveBeenCalledWith(expect.stringMatching(/.*\/tickets\/ticket-123\/thumbnails\/test\.jpg$/));
        });
        it('should delete all thumbnails for ticket', async () => {
            const ticketId = 'ticket-123';
            await service.deleteThumbnails(ticketId);
            expect(fsMock.remove).toHaveBeenCalledWith(expect.stringMatching(/.*\/tickets\/ticket-123\/thumbnails$/));
        });
...
//# sourceMappingURL=thumbnail.service.spec.js.map